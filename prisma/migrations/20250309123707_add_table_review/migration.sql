...
-- AddForeignKey
ALTER TABLE `review_user_film` ADD CONSTRAINT `review_user_film_film_id_fkey` FOREIGN KEY (`film_id`) REFERENCES `books`(`book_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
